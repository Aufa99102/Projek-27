...
const fields = [
  ...
  { name: "gs", label: "GS (cm)", required: true, numericOnly: true, allowDecimal: true },
  { name: "crl", label: "CRL (cm)", required: true, numericOnly: true, allowDecimal: true },
  { name: "djj", label: "DJJ", required: true, numericOnly: true },
  {
    ...
    type: "select",
    required: true,
    options: ["Intrauterin", "Ekstrauterin"],
  },
